package com.example.rentit.presentation.rentaldetail.renter.photobeforereturn.dialog
...
@Composable
fun PreviousPhotoLoadFailedDialog(onDismiss: () -> Unit = {}) {
    BaseDialog(
...
@Composable
fun PreviousPhotoLoadFailedDialogPreview() {
    RentItTheme {
        PreviousPhotoLoadFailedDialog(
        )
    }
}