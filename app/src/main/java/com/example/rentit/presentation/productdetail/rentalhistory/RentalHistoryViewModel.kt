...
class RentalHistoryViewModel @Inject constructor(
    ...
    private val sampleRentalHistoryList = listOf(
        RentalHistoryListItemModel(105, 505, RentalStatus.RENTING, "Eve", RentalPeriodModel(
            LocalDate.parse("2025-09-14"), LocalDate.parse("2025-09-16")), "2025-09-05T14:00:00"),
        RentalHistoryListItemModel(109, 509, RentalStatus.PAID, "Ian", RentalPeriodModel(LocalDate.parse("2025-09-18"), LocalDate.parse("2025-09-20")), "2025-09-09T18:10:00"),
        RentalHistoryListItemModel(104, 504, RentalStatus.PAID, "David", RentalPeriodModel(LocalDate.parse("2025-09-13"), LocalDate.parse("2025-09-14")), "2025-09-04T13:45:00"),
        RentalHistoryListItemModel(101, 501, RentalStatus.PENDING, "Alice", RentalPeriodModel(
            LocalDate.parse("2025-09-10"), LocalDate.parse("2025-09-12")), "2025-09-01T10:00:00"),
        RentalHistoryListItemModel(102, 502, RentalStatus.ACCEPTED, "Bob", RentalPeriodModel(
            LocalDate.parse("2025-09-11"), LocalDate.parse("2025-09-13")), "2025-09-02T11:15:00"),
        RentalHistoryListItemModel(103, 503, RentalStatus.REJECTED, "Charlie", RentalPeriodModel(
            LocalDate.parse("2025-09-12"), LocalDate.parse("2025-09-14")), "2025-09-03T12:30:00"),
        RentalHistoryListItemModel(106, 506, RentalStatus.RETURNED, "Frank", RentalPeriodModel(
            LocalDate.parse("2025-09-15"), LocalDate.parse("2025-09-17")), "2025-09-06T15:20:00"),
        RentalHistoryListItemModel(107, 507, RentalStatus.CANCELED, "Grace", RentalPeriodModel(
            LocalDate.parse("2025-09-16"), LocalDate.parse("2025-09-18")), "2025-09-07T16:40:00"),
        RentalHistoryListItemModel(110, 510, RentalStatus.RETURNED, "Jane", RentalPeriodModel(
    ...
    fun updateFilterMode(filterMode: RentalHistoryFilter){
        updateUiState { copy(filterMode = filterMode) }
    }
}